...
class ShellyDallasNewTemperatureSensor;
...
class ShellyDallasComponentnew : public PollingComponent {
 ...
 protected:
  ...
  std::vector<ShellyDallasNewTemperatureSensor *> sensors_;
...
class ShellyDallasNewTemperatureSensor : public sensor::Sensor {
 public:
  ...
  ShellyDallasNewTemperatureSensor(uint64_t address, uint8_t resolution, ShellyDallasComponent *parent);
 ...
 protected:
  ShellyDallasComponentnew *parent_;
  uint64_t address_;
