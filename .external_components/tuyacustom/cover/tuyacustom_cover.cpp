...
static const char *const TAG = "tuyacustom.cover";

void TuyaCustomCover::setup() {
  ...
  this->parent_->register_listener(report_id, [this](const TuyaCustomDatapoint &datapoint) {
...
void TuyaCustomCover::control(const cover::CoverCall &call) {
  if (call.get_stop()) {
...
void TuyaCustomCover::set_direction_(bool inverted) {
...
void TuyaCustomCover::dump_config() {
  ESP_LOGCONFIG(TAG, "tuyacustom Cover:");
...
cover::CoverTraits TuyaCustomCover::get_traits() {
