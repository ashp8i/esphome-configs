...
#include "esphome/components/tuyacustom/tuyacustom.h"
#include "esphome/components/cover/cover.h"

namespace esphome {
namespace tuyacustom {

enum TuyaCustomCoverRestoreMode {
  COVER_NO_RESTORE,
  COVER_RESTORE,
  COVER_RESTORE_AND_CALL,
};

class TuyaCustomCover : public cover::Cover, public Component {
 public:
  void setup() override;
  ...
  void set_tuyacustom_parent(TuyaCustom *parent) { this->parent_ = parent; }
  ...
  void set_restore_mode(TuyaCustomCoverRestoreMode restore_mode) { restore_mode_ = restore_mode; }
 ...
 protected:
  ...
  TuyaCustom *parent_;
  TuyaCustomCoverRestoreMode restore_mode_{};
