...
//  public:
//   explicit OneWireBusComponent(InternalGPIOPin *pin);
...
class OneWireBusComponent : public PollingComponent {
 public:
  ...
  void register_sensor(OneWireBusComponent *sensor);
 ...
 protected:
  ...
  bool last_device_flag_{false};
  uint64_t rom_number_{0};
  friend OneWireBusComponent;

  InternalGPIOPin *pin_;
  OneWireBusComponent *one_wire_;
  std::vector<OneWireBusComponent *> sensors_;
...
// class OneWireBusComponent : public sensor::Sensor {
//  public:
