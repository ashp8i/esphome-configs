...
#     UNIT_CELSIUS,
# )
# from . import OneWireBusComponent, onewirebus_ns

# OneWireTemperatureSensor = onewirebus_ns.class_("OneWireTemperatureSensor", sensor.Sensor)
...
#     ).extend(
#         {
#             cv.GenerateID(CONF_DALLAS_ID): cv.use_id(OneWireBusComponent),
